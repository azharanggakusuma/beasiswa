...
<head>
  ...
  <title>Add Beasiswa - Administrator</title>
...
<body>
    ...
    <div class="container py-5">
      <div class="row justify-content-center">
        <div class="col-lg-10 text-center">
          <h1 class="display-6 text-white animated slideInDown">Tambah Data Beasiswa</h1>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
              <li class="breadcrumb-item"><a class="text-white" href="index.php">Administrator</a></li>
              <li class="breadcrumb-item text-white active" aria-current="page">Tambah Beasiswa</li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <div class="container py-5">
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
      <h3 class="mb-5">Tambah Beasiswa</h2>
    </div>
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <form action="process_add.php" method="post" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_beasiswa" name="nama_beasiswa" placeholder="Masukkan nama beasiswa" required>
          </div>

          <button type="submit" class="btn btn-primary" style="border-radius: 4px;">Tambah</button>
        </form>
      </div>
    </div>
  </div>
