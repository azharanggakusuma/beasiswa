  ...
  <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0 fixed">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <div class="navbar-nav ms-auto p-4 p-lg-0">
        ...
        <a href="beasiswa.php" class="nav-item nav-link">Beasiswa</a>
    ...
    <div class="container py-5">
      <div class="row justify-content-center">
        <div class="col-lg-10 text-center">
          <h1 class="display-6 text-white animated slideInDown">Pendaftar Beasiswa</h1>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
              <li class="breadcrumb-item"><a class="text-white" href="index.php">Admin</a></li>
          ...
          if (!$result) {
            ...
            foreach ($result as $row) {
              ...
              <tr>
                ...
                <!--
                <td>
                  <form class="d-flex" method='POST' action='config/update_status.php'>
                ...
                -->
                <td>
                  <form class="d-flex" method='POST' action='../config/update_status.php' onchange="updateStatus(this)">
                    <input type='hidden' name='registration_id' value='<?php echo $row['id']; ?>'>
                    <select class="form-select me-2" name='new_status' style="min-width: 130px;">
                      <option value='Diterima' style="display: none;" selected>Pilih Status</option>
                ...
                <script>
                  function updateStatus(formElement) {
                    var registrationId = formElement.querySelector('[name="registration_id"]').value;
                    var newStatus = formElement.querySelector('[name="new_status"]').value;

                    $.ajax({
                      type: "POST",
                      url: "../config/update_status.php",
                      data: {
